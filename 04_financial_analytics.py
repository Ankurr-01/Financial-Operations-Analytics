...
Original file is located at
    https://colab.research.google.com/drive/11T6GYJtb3zoLMSN_IL0HqOgxnAvqDa6X
"""
...
# The 'year_month' should not be a string or object for data modeling
print(monthly_revenue.dtypes)
print(type(monthly_revenue['year_month'].iloc[0]))
...
# ============================================================================
# 7.2: EXECUTIVE SUMMARY AND REPORTING
# ============================================================================
"""
Create a comprehensive executive summary that stakeholders can use
to make informed decisions regarding revenue growth, customer retention,
...
Objective: Forecast recurring revenue, predict customer churn, and optimize customer
profitability for SaaS subscription-based businesses.
Dataset: Synthetic SaaS customer, transaction, and monthly revenue datasets.
Total Customers: {total_customers_current:,}
Analysis Period: 5-year end-to-end financial analytics pipeline.

Business Scale
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Current Customer Base          : {total_customers_current:,}
Active Customers               : {active_customers_current:,}
Current Monthly Recurring Rev. : ${total_mrr_current:,.2f}
Annual Recurring Revenue       : ${total_arr:,.2f}
Total Historical Revenue       : ${total_revenue_all_time:,.2f}
...
1. BUSINESS PERFORMANCE
   - Total historical revenue: ${total_revenue_all_time:,.2f}
   - Current Monthly Recurring Revenue (MRR): ${total_mrr_current:,.2f}
   - Annual Recurring Revenue (ARR): ${total_arr:,.2f}
   - Revenue growth over the last six months: {revenue_growth_rate:+.2f}%

2. CUSTOMER ANALYTICS
   - Overall customer churn rate: {churn_rate_current:.2f}%
   - Active customers: {active_customers_current:,}
   - Average Customer Lifetime Value (CLV): ${avg_clv_current:,.2f}
   - Average customer lifetime: {customers['lifetime_months'].mean():.1f} months
...
3. MODEL PERFORMANCE
   - Best Model: {best_churn_model_name}
   - Test Accuracy: {comparison_df.loc[best_churn_model_name,'accuracy']:.2%}
   - Precision: {comparison_df.loc[best_churn_model_name,'precision']:.2%}
   - Recall: {comparison_df.loc[best_churn_model_name,'recall']:.2%}
   - F1 Score: {comparison_df.loc[best_churn_model_name,'f1']:.2%}
   - ROC AUC: {comparison_df.loc[best_churn_model_name,'roc_auc']:.4f}

CUSTOMER RISK ANALYSIS
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   Total Customers: {risk_analysis['Total_Customers'].sum():,.0f}
   Total At-Risk Customers: {len(at_risk):,}
   Monthly Revenue at Risk: ${at_risk_mrr:,.2f}
   Annual Revenue at Risk: ${at_risk_mrr * 12:,.2f}

CUSTOMER RISK STRATIFICATION
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   Low Risk: {risk_analysis.loc['Low Risk','Total_Customers']:.0f} customers ({risk_analysis.loc['Low Risk','Churn_Rate']:.1f}% churn rate)
   Medium Risk: {risk_analysis.loc['Medium Risk','Total_Customers']:.0f} customers ({risk_analysis.loc['Medium Risk','Churn_Rate']:.1f}% churn rate)
   High Risk: {risk_analysis.loc['High Risk','Total_Customers']:.0f} customers ({risk_analysis.loc['High Risk','Churn_Rate']:.1f}% churn rate)
   Very High Risk: {risk_analysis.loc['Very High Risk','Total_Customers']:.0f} customers ({risk_analysis.loc['Very High Risk','Churn_Rate']:.1f}% churn rate)

BUSINESS IMPACT
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   Revenue Performance:
   - Forecasted Revenue (Next 12 Months): ${forecast.sum():,.2f}
   - Current Monthly Recurring Revenue (MRR): ${total_mrr_current:,.2f}
   - Annual Recurring Revenue (ARR): ${total_arr:,.2f}

   Customer Retention:
   - Customers requiring retention efforts: {len(at_risk):,}
   - Monthly Revenue at Risk: ${at_risk_mrr:,.2f}
   - Annual Revenue at Risk: ${at_risk_mrr * 12:,.2f}
   - Average CLV of At-Risk Customers: ${at_risk['clv'].mean():,.2f}

RECOMMENDATIONS
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
1. IMMEDIATE ACTIONS
   - Prioritize proactive outreach for High and Very High Risk customers.
   - Launch targeted retention campaigns using churn risk scores.
   - Monitor Monthly Recurring Revenue (MRR) at risk through executive dashboards.

2. RESOURCE ALLOCATION
   - Allocate customer success resources based on churn probability and CLV.
   - Prioritize enterprise and high-value customer accounts.
   - Optimize retention investment using predictive analytics.

3. CUSTOMER RETENTION
   - Improve customer onboarding and product adoption.
   - Increase engagement for low-usage customers.
   - Monitor customer satisfaction using NPS and support metrics.

4. MODEL DEPLOYMENT
   - Integrate churn prediction into CRM systems.
   - Provide real-time customer risk scores to Customer Success teams.
   - Automate monthly revenue forecasting and executive reporting.

5. CONTINUOUS IMPROVEMENT
   - Retrain forecasting and churn prediction models using new customer data.
   - Continuously monitor model performance.
   - Evaluate additional behavioural and financial features to improve prediction accuracy.

LIMITATIONS AND CONSIDERATIONS
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
- Dataset is synthetically generated for learning purposes
- Forecasting assumes historical business trends continue into the future
- Customer Acquisition Cost (CAC) is assumed for CLV ratio calculations
- External market conditions are not included in forecasting
- Model performance should be validated before deployment in production

TECHNICAL SPECIFICATIONS
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
- Programming Language: Python 3.x
- Key Libraries: pandas, scikit-learn, matplotlib, seaborn, statsmodels
- Forecasting Model: ARIMA
- Churn Prediction Model: {best_churn_model_name}
- Features Used: {len(feature_columns)} customer and business features
...
NEXT STEPS
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
1. Deploy revenue forecasting into business reporting workflows
2. Integrate churn prediction into CRM systems
3. Develop automated executive dashboards
4. Monitor model performance using new business data
5. Retrain models periodically with updated customer information
6. Expand analytics with additional financial and customer behavior metrics
...
with open("EXECUTIVE_SUMMARY_FINANCIAL.txt", "w", encoding="utf-8") as f:
    f.write(summary_report)

print("\n✓ Executive summary saved to: 'EXECUTIVE_SUMMARY_FINANCIAL.txt'")
